...
export const getStartUpById = async(startupId) => {
  try{
    ...
    const response = await axiosInstance.get(API.getStartUpById + "/" + startupId);
    console.log(response);
    return response;
  } catch (error) {
    throw error;
...
export const getTotalUnreadMessagesCount = async (userId) => {
  try {
    const response = await axiosInstance.get(`${API.getTotalUnreadMessagesCount}/${userId}`);
    return response.data;
  } catch (error) {
...
export const getUserByUserName = async (username)=>{
  try{
    const response = await axiosInstance.post(API.getUserByUserName, {username});
    return response;
...
export const validateMeetingAuth = async(code)=>{
  try {
    const response = await axiosInstance.post(`${API.validateMeetingAuth}`,{code});
    return response.data;
  } catch (error) {
    throw error;
  }
...
export const getSubscriptionUrl = async (orderId) => {
  try {
    const response = await axiosInstance.post(`${API.getPaymentDetail}`, { orderId });
    return response.data;
  } catch (err) {
    console.error(err); 
    throw err; 
...
async function blockUser(userId, blockedUserId){
  try{
    const response = await axiosInstance.post(API.blockuser, {userId, blockedUserId});
    return response.data;
  } catch(error){
...
async function unblockUser(userId, unblockUserId){
  try{
    const response = await axiosInstance.post(API.unblockUser, {userId, unblockUserId});
    return response.data;
  } catch(error){
    console.error("Error blocking user:", error.response?.data || error.message);
    throw error;
...
export const getMessageByChatId = async (chatId, currentUserId) => {
  try {
    const { data } = await axiosInstance.get(
      `${API.getMessageByChatId}/${chatId}`, {currentUserId}
    );
    return data;
  } catch (error) {
    console.error("Error getting user message:", error);
...
try{
  const response = await axiosInstance.post(`${API.clearChat}/${chatId}`, {userId});
  return response;
}catch(error){
  console.error(error);
  throw error;
