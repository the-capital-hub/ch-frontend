						...
						<div className="image_name_section mt-2">
							...
							<div className="left_profile_text flex_content ms-3">
								...
								<div className="d-flex flex-column flex-md-row gap-2">
									...
									<span className="small_typo_location text-secondary">
										<img src={upgraphIcon} alt="location" /> Last Funding in
										May, 2023
									</span>
								</div>
							</div>
				...
				<div className="row about_company_section">
					...
					<div className="col-lg-9 col-md-12">
						<p>
							...
							elegant reality. Humbled and honored to have worked with Angels
							and VC's across the globe to support and grow the startup
							culture.With the vision of make in India for the world, they
							design and build augmented reality glasses for Defence,
							Enterprise, and Training sectors. In addition to hardware, they
							also provide their clients with end-to-end AR/VR/MR solutions that
							are tailored to their business needs.
						</p>
					</div>
				</div>
