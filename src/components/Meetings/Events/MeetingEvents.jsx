                        ...
                        >
                            <div className="event-info">
                                ...
                                <div className="event-meta">
									<div className="leftTime">
										<span><IoCalendarOutline size={20}/></span> &nbsp;&nbsp;
										...
										<div className="price-tag">
											{event.discount > 0 && (
												...
												<span className="new-price">
													₹{(event.price * (1 - event.discount / 100)).toFixed(0)}
												</span>
											</div>
										) : (
											<div className="price-tag"><b>Free</b></div>
										)}
									</div>
                            ...
                            <div className="event-actions">
                                <div className="action-buttons">
                                    <button className="copy-btn" onClick={() => handleCopy(event._id)}>
                                        <FiCopy />
                                ...
                                <div className="bookings-count">
                                    {event.bookings.length} {event.bookings.length === 1 ? "Booking" : "Bookings"}
                                </div>
                            </div>
                        </div>
                    ))}
