          ...
          <div className="d-flex gap-4" style={{ width: "100%" }}>
            ...
            <div className="d-flex flex-column justify-content-center gap-1 ">
              <div style={{ display: "flex" }}>
                <h5 className="m-0 fw-semibold">{professionalData.fullName}
              ...
              <p className="m-0">
                {professionalData.designation && (
                  <>
                    {professionalData.designation}
                    {professionalData.company && ` of ${professionalData.company}`}
                  </>
                )}
                {professionalData.location && (professionalData.designation || professionalData.company) && `, ${professionalData.location}`}
              </p>
