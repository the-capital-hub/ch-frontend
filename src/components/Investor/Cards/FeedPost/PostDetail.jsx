                  ...
                  <div className="d-none d-sm-flex align-items-center gap-1 justify-content-around" style={{ width: "25%" }}>
                    {liked ? (
                      <div className="d-flex align-items-center justify-content-end gap-1" onClick={likeUnlikeHandler}>
                        ...
                        <p style={{ color: "var(--d-l-grey)", fontSize: "10px", cursor: "pointer" }} className="m-0 actions-btn-text-hide">Like</p>
                      </div>
                    ) : (
                      <div className="d-flex align-items-center justify-content-end gap-1" onClick={likeUnlikeHandler}>
                        <ImFire style={{ cursor: "pointer", fill: "var(--d-l-grey)" }} />
                        <p style={{ color: "var(--d-l-grey)", fontSize: "10px", cursor: "pointer" }} className="m-0 actions-btn-text-hide">Like</p>
                      </div>
                    )}
                    {!showComment ? (
                      <div className="d-flex align-items-center justify-content-end gap-1" onClick={() => setShowComment((prev) => !prev)}>
                        <FaRegCommentDots size={20} style={{ cursor: "pointer", fill: "var(--d-l-grey)" }} />
                        <p style={{ color: "var(--d-l-grey)", fontSize: "10px", cursor: "pointer" }} className="m-0 actions-btn-text-hide">Comment</p>
                      </div>
                    ) : (
                      <div className="d-flex align-items-center justify-content-end gap-1" onClick={() => setShowComment((prev) => !prev)}>
                        <FaCommentDots size={20} style={{ cursor: "pointer", fill: "var(--d-l-grey)" }} />
                        <p style={{ color: "var(--d-l-grey)", fontSize: "10px", cursor: "pointer" }} className="m-0 actions-btn-text-hide">Comment</p>
                      </div>
                    )}
                  </div>
                  <span className={`repost_container rounded-4 ${showRepostOptions ? "bg-light" : ""}`} ref={repostContainerRef}>
                    <div className="d-flex align-items-center justify-content-end gap-1" onClick={() => setShowRepostOptions(!showRepostOptions)} style={{ cursor: "pointer", backgroundColor: "#fd5901", padding: "0.5rem 0.75rem", borderRadius: "2.5rem" }}>
                      <BiRepost style={{ cursor: "pointer", transform: "rotate(90deg)", fill: "var(--d-l-grey)" }} size={20} />
                      <p style={{ color: "var(--d-l-grey)", fontSize: "10px" }} className="m-0 actions-btn-text-hide">Repost</p>
                    </div>
                    {showRepostOptions && (
                      <span className="repost_options border rounded shadow-sm">
                        <button className="single_option btn text-start py-1 px-1 rounded border-bottom" onClick={() => repostWithToughts(postId)}>
                        ...
                        <button className="single_option btn text-start py-1 ps-0 rounded border-bottom" onClick={() => repostInstantly(postId)}>
                          ...
                          <div className="d-flex flex-column g-1 ">
                            ...
                            <span className="description">Instantly bring to other's feed</span>
                          </div>
                        </button>
                      </span>
                    )}
                  </span>
                  <div className="d-flex align-items-center gap-1" onClick={handleOpenSocialShare}>
                    <FaShare size={20} style={{ cursor: "pointer", fill: "var(--d-l-grey)" }} />
                    <p style={{ color: "var(--d-l-grey)", fontSize: "10px", cursor: "pointer" }} className="m-0 actions-btn-text-hide">Share</p>
                  </div>
                  {savedPostId.includes(postId) ? (
                    <div className="d-flex align-items-center justify-content-end gap-1" onClick={handleUnsavePost}>
                      <IoMdBookmark size={20} style={{ cursor: "pointer", fill: "var(--d-l-grey)" }} />
                      <p style={{ color: "var(--d-l-grey)", fontSize: "10px", cursor: "pointer" }} className="m-0 actions-btn-text-hide">Saved</p>
                    </div>
                  ) : (
                    <div className="d-flex align-items-center justify-content-end gap-1" onClick={handleSavePopUp}>
                      <CiBookmark size={20} style={{ cursor: "pointer", fill: "var(--d-l-grey)" }} />
                      <p style={{ color: "var(--d-l-grey)", fontSize: "10px", cursor: "pointer" }} className="m-0 actions-btn-text-hide">Save</p>
                    </div>
                  )}
                </div>
              </div>
