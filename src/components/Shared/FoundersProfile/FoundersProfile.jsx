...
// 					{founderData.activities.posts.map((post, index) => (
...
// 								<div className="no-data-message">
// 									<p>
// 										No education data available. Please add your education
// 										details.
// 									</p>
// 								</div>
// 							)}
...
// 								<div className="no-data-message">
// 									<p>
// 										No experience data available. Please add your experience.
// 									</p>
// 								</div>
// 							)}
// 						</div>
						...
						<div className="profile-info">
							...
							<p className="title">
								{loading ? (
									...
									founder?.startUp?.company || "No Data Available"
								)}
							</p>
							<p className="company">
								{loading ? (
									...
									founder?.designation || "No Data Available"
								)}
							</p>
							...
							<div className="location">
								...
								<span>
									{loading ? (
										...
										founder?.startUp?.location || "No Data Available"
									)}
								</span>
							</div>
						</div>
