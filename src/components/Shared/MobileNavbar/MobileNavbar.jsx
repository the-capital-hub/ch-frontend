		...
		<div className="mobile-bottom-toolbar container p-2 shadow d-flex gap-1 justify-content-between border-top align-items-center px-3 d-md-none text-secondary">
			...
			<div className="d-flex flex-column align-items-center mx-3">
				<NavLink to={isInvestor ? "/investor/home" : "/home"}>
					<img src={Home} className="nav-link-icon" alt="Home" srcset="" />
				</NavLink>
			...
			>
				<img src={AddPost} className="nav-link-icon" alt="Home" srcset="" />
			...
			<div className="d-flex flex-column align-items-center mx-3">
				<NavLink to="/chats?isCommunityOpen=true">
					<img src={Community} className="nav-link-icon" alt="Home" srcset="" />
				</NavLink>
			...
			<div className="d-flex flex-column align-items-center mx-3">
				<NavLink to="/profile">
					<img src={Profile} className="nav-link-icon" alt="Home" srcset="" />
				</NavLink>
