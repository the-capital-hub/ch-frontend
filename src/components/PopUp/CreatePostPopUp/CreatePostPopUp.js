...
import videoicon from "../../../Images/NewInvestor/videoicon.png";
import docicon from "../../../Images/NewInvestor/docicon.png";
import imageicon from "../../../Images/NewInvestor/imageicon.png";
...
const CreatePostPopUp = ({
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			console.log("StartupNewPost", response.data);
			...
			>
				<div className="modal-dialog modal-dialog-centered" role="document">
						...
						<div className="modal-body">
							<div className="createpost_text_area">
								<ReactQuill
									...
									className="custom-scrollbar custom-quill"
								/>
								{respostingPostId &&
									(loadingRepostData ? (
							...
							<div className="main-image">
								<span className="image-header">Post Main Image</span>
								<div className="upload__image">
									...
									<label
										...
										className="text-black fw-lighter"
									>
                    ...
                    /> */}
                      ...
                      style={{ color: "var(--d-l-grey)" }}
                    /> */}
										<img src={videoicon} alt="file icon" />
