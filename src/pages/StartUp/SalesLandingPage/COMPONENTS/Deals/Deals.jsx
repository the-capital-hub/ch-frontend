  ...
  return (
    <div className="deals-container">
      <div className="inner-container">
        <center><p className="head">How We Work</p></center>
        <h2 className="head-two">Why Join <span>Hustlers Club?</span></h2>
      ...
      <div className="exc-outer">
        <div className="exclusive-content">
              <div className="content-left">
                ...
                <p>Learn from top investors and founders. These invite-only sessions will help you sharpen your growth strategies.</p>
        ...
        <div className="exclusive-content2">
              <div className="content-left">
                ...
                <p>Book private sessions with industry leaders who can offer insights on fundraising, business strategy, and growth.
                </p>
              </div>       
        </div>
