...
export default function EditCompanyProfilePage() {
  ...
  const userSocialLinksLinks = useSelector(selectUserSocialLinks);
  ...
  }, [isSaveAll, dispatch, loggedInUserId, userCompanyData, publicLinks]);
  ...
  <PublicLinks
    publicLinks={companyData.socialLinks}
    investor={loggedInUser.isInvestor}
    loading={loading}
