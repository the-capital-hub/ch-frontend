...
//     setProcessing(true);
//     try {
//       const response = await fetch(`${environment.baseUrl}/resources/purchase/${resource._id}`, {
//         method: "POST",
//         headers: {
//           "Content-Type": "application/json",
//         },
...
//               <FaFileAlt size={50} color="#4a90e2" />
//             </div>
//             <div className="card-header">
//               <h3>{resource.title}</h3>
//               {loggedInUser?.isAdmin && (
//                 <button
//                   className={`status-toggle ${resource.isActive ? 'active' : 'inactive'}`}
//                   onClick={() => toggleResourceStatus(resource._id, resource.isActive)}
//                 >
//                   Mark as {resource.isActive ? 'Inactive' : 'Active'}
//                 </button>
//               )}
//             </div>
//             <div className="card-content">
//               <p>{resource.description}</p>
//               <p className="price">₹{resource.amount}</p>
//               <div className="action-buttons">
//                 {isAdmin || resource.purchased_users?.includes(loggedInUser?._id) ? (
//                   <button
...
//             <button className="close-btn" onClick={() => setShowDownloadLinks(false)}>&times;</button>
...
//                 </a>
//               ))}
//               <button onClick={() => setShowDownloadLinks(false)}>Close</button>
//             </div>
//           </div>
//         </div>
//       )}
